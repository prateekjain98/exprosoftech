...
export const defaultCloudSpecializations: CloudSpecialization[] = [
  {
    ...
    name: "Data Cloud",
    description:
      "Unify and activate your customer data across every touchpoint with intelligent data management and real-time insights.",
    icon: "FaDatabase",
    features: [
      "Data Integration",
      "Real-time Analytics",
  ...
  },
  {
    ...
    name: "Sales Cloud",
    description:
      "Accelerate your sales process with intelligent automation, pipeline management, and predictive analytics.",
    icon: "FaChartLine",
    features: [
      "Lead Management",
  ...
  },
  {
    ...
    name: "Service Cloud",
    description:
      "Deliver exceptional customer service with omnichannel support, case management, and AI-powered solutions.",
    icon: "FaHeadphones",
    features: [
      "Case Management",
      "Omnichannel Support",
  ...
  },
  {
    ...
    description:
      "Create personalized digital experiences that connect customers, partners, and employees seamlessly.",
    icon: "FaGlobe",
    features: [
      "Community Building",
      "Partner Portals",
  ...
  },
  {
    ...
    description:
      "Optimize field operations with intelligent scheduling, mobile workforce management, and IoT integration.",
    icon: "FaBolt",
    features: [
  ...
  },
  {
    ...
    description:
      "Transform manufacturing operations with account-based forecasting, partner management, and supply chain visibility.",
    icon: "FaIndustry",
    features: [
      "Account Planning",
      "Partner Management",
  ...
  },
  {
    ...
    name: "CRM Analytics",
    description:
      "Turn data into actionable insights with advanced analytics, AI-powered predictions, and interactive dashboards.",
    icon: "FaChartLine",
    features: [
      "Advanced Analytics",
      "AI Predictions",
  ...
  },
  {
    ...
    name: "Revenue Cloud",
    description:
      "Streamline your revenue operations with intelligent quoting, contract management, and subscription billing.",
  ...
  },
  {
    ...
    description:
      "Transform educational experiences with student lifecycle management, recruitment, and engagement tools.",
...
const CloudCard: React.FC<{ cloud: CloudSpecialization; index: number }> = ({
  cloud,
  index,
}) => {
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              {cloud.features?.map((feature, featureIndex) => (
                ...
                >
                  <div
                    className="h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 flex-shrink-0
...
export const CloudSpecializations: React.FC<Props> = ({
  ...
  heading = {
    ...
    description:
      "We help businesses transform with comprehensive cloud solutions across the entire Salesforce ecosystem",
  },
  data,
}) => {
