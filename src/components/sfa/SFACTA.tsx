...
// const SFACTA: React.FC<CTAProps> = ({ ctaContent }) => {
//   return (
...
//                   Experience the power of modern sales force automation that
//                   streamlines operations, boosts productivity, and drives
//                   revenue growth with real-time insights and smart analytics.
//                 </p>
