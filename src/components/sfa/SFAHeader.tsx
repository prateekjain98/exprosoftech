...
export const SFAHeader: React.FC<SFAHeaderProps> = ({ className }) => {
  const { title, subtitle, description, image, buttons } = headerData;

  return (
    <section className="relative z-[1] py-12 overflow-hidden">
